...
SECRET_KEY = 'django-insecure-7@4_$tn8$9(j^%t=8dubn-2)8(5c*@2g(!n1vt4r#6jot&g!kr'
...
# Medya dosyalarının bilgisayarda saklanacağı fiziksel klasör
MEDIA_ROOT = os.path.join(BASE_DIR, 'media')

# --- settings.py dosyasının EN ALTI ---

print("\n" + "="*30)
print("🔍 DEBUG: YOL KONTROLÜ")
print(f"📂 BASE_DIR (Proje Ana Dizini): {BASE_DIR}")
